...
/**
 * Generates the static API reference site for milpa/live.
 *
...
$config = new Milpa\Docs\SiteConfig(
    brand: 'Milpa Live',
    nsPrefix: 'Milpa\\Live\\',
    installCommand: 'composer require milpa/live',
    repoUrl: 'https://github.com/getmilpa/live',
    pagesUrl: 'https://getmilpa.github.io/live/',
    heroParagraph: 'Render-target-agnostic <strong>live components</strong> for the Milpa framework — the same '
        . 'component definition renders to <strong>web AND terminal</strong>; state, data sources, and an '
